    ...
    <section ref={sectionRef} className="mt-16">
      <div className="grid lg:grid-cols-2 font-sans">
        ...
        <div className="flex flex-col px-6 md:px-10 lg:px-14 py-12 lg:py-16">
          <span
            ref={labelRef}
            className="text-[11px] font-medium tracking-[0.16em] uppercase text-red-700 mb-6"
          >
            ABOUT MORZ GLOBAL
          </span>
          ...
          <h2
            ref={headingRef}
            className="text-3xl md:text-4xl lg:text-[46px] font-bold leading-[1.06] tracking-[-0.025em] text-[#1A1714] mb-6 flex-1 font-serif"
          >
            We deliver{" "}
            <em className="italic font-light text-primary">reliable</em>
            <br />
            reliable machinery solutions
            <br />
          ...
          <p
            ref={paraRef}
            className="text-sm leading-[1.85] text-[#7A7570] font-light mb-2 d"
          >
          ...
          <p
            ref={paraRef}
            className="text-sm leading-[1.85] text-[#7A7570] font-light mb-6 "
          >
          ...
          <div ref={ctaRef} className="flex items-center gap-4 flex-wrap">
            <button className="inline-flex items-center gap-2 bg-primary hover:bg-red-700 text-[#F7F5F2] px-5 py-3 rounded-sm text-xs font-medium tracking-[0.07em] uppercase transition-colors duration-200 group">
              Learn more
              <ArrowRight />
            </button>
